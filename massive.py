...
if __name__ == "__main__":
    ...
    assets = ["AMPUSDT", "HBARUSDT"]
    atr_windows = [2, 5, 6, 8, 12, 18, 26]
    atr_multipliers = [0.5, 0.9, 1.1, 1.3, 1.5, 1.6, 1.7, 1.8, 2.0]
    sma_windows = [2, 5, 6, 8, 12, 18, 26]
    steps = [0.01]
