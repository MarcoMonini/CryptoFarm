        ...
        for asset in assets:
            ...
            for atr_multiplier in atr_multipliers:
                for atr_window in atr_windows:
                    for din_macd_div in din_macd_divs:
                        for din_roc_div in din_roc_divs:
                            try:
                            ...
                            if trades_df.empty:
                                simulazioni.append({
                                    ...
                                    'MACD Dividend': din_macd_div,
                                    'ROC Dividend': din_roc_div,
                                    'Profitto Totale': 0,
                                    'Profitto Medio': 0,
                                    'Operazioni Chiuse': 0,
...
if __name__ == "__main__":
    ...
    # num_conds = [2]
    atr_multipliers = [1.2, 1.4, 1.6, 1.8, 2.0, 2.2]
    atr_windows = [6]
    din_macd_divs = [1,1.1, 1.2,1.3, 1.4]
